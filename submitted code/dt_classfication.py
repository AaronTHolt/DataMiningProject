...
"""
Description     : Implementing the DT classification
"""
...
if __name__ == "__main__":
    ...
    #Model DecisionTreeClassfier Using all Internal and External Features
    clf = tree.DecisionTreeClassifier()
    clf.fit(x_train_all_feature, y_train)
    predictions = clf.predict(x_test_all_feature)
    print("\n1. DT Result of Using ALL INTERNAL and EXTERNAL Features")
    print("----------------------------------------------------")
    ...
    #Model DecisionTreeClassfier Using Only External Features
    clf = tree.DecisionTreeClassifier()
    clf.fit(x_train_only_ext_feature, y_train)
    predictions = clf.predict(x_test_only_ext_feature)
    print("\n2. DT Result of Using ONLY EXTERNAL Features")
    print("----------------------------------------------------")
