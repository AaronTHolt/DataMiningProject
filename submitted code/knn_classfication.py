...
"""
Description     : Implementing the KNN classification
"""
...
if __name__ == "__main__":
    ...
    #Model kNN Classfier Using all Internal and External Features
    clf = KNeighborsClassifier(n_neighbors=3)
    clf.fit(x_train_all_feature, y_train)
    predictions = clf.predict(x_test_all_feature)
    print("\n1. kNN Result of Using ALL INTERNAL and EXTERNAL Features")
    print("----------------------------------------------------")
    ...
    #Model kNN Classfier Using Only External Features
    clf = KNeighborsClassifier(n_neighbors=3)
    clf.fit(x_train_only_ext_feature, y_train)
    predictions = clf.predict(x_test_only_ext_feature)
    print("\n2. kNN Result of Using ONLY EXTERNAL Features")
    print("----------------------------------------------------")
